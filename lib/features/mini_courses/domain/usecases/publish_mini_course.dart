...
class PublishMiniCourse implements UseCase<MiniCourse, String> {
  final MiniCourseRepository repository;

  PublishMiniCourse(this.repository);

  @override
  Future<Either<Failure, MiniCourse>> call(String miniCourseId) async {
    return await repository.publishMiniCourse(miniCourseId: miniCourseId);
  }
}